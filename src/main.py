...
class ApiMasterAI:
    ...
    def __init__(self, target_app: str, base_url: str, openapi_json_path: str):
...
def start_api_master(openai_key: str, target_app: str | None = None, openapi_json: str | None = None, base_url="http://0.0.0.0:8000", verbose: bool = False) -> callable:
    if verbose:
    ...
    api_master_ai = ApiMasterAI(target_app=target_app, base_url=base_url, openapi_json_path=openapi_json)
    api_master_ai.start()
    q = api_master_ai.q
